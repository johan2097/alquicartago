            ...
            <Row className="form__row">
              <Col lg="4" md="4">
                <div className="find__cars-left">
                  <h2>Encuentra tu mejor vehiculo</h2>
                </div>
              </Col>
        ...
        <Container>
          <Row>
            <Col lg="12" className="mb-5 text-center">
              <h6 className="section__subtitle">Mira lo Nuestro</h6>
        ...
        <Container>
          <Row>
            <Col lg="12" className="text-center mb-5">
              <h6 className="section__subtitle">Ven con nosotros</h6>
        ...
        <Container>
          <Row>
            <Col lg="12" className="mb-5 text-center">
              ...
              <h2 className="section__title">Ultimas Novedades</h2>
            </Col>
